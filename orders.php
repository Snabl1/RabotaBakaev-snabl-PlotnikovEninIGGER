...
// Получение всех заказов с информацией - исправляем JOIN для работы с удаленными БД
$orders = $pdo->query("
    SELECT o.*, c.last_name, c.first_name,
           o.zone_id, o.warranty_id,  -- Берем ID для последующих запросов
    ...
    <div class="menu">
        <nav class="menu-nav">
            ...
            <?php else: ?>
                ...
                <a href="orders.php" class="active icon-tank">Заказы</a>
            <?php endif; ?>
        </nav>
    </div>
