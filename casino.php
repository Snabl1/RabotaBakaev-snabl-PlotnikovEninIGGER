...
<head>
    ...
    <title>1TANK — Танковая игровая платформа</title>
    <link rel="stylesheet" href="style-anime.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* ===== 1TANK — СОВРЕМЕННЫЙ ИГРОВОЙ СТИЛЬ ===== */
        :root {
            --tank-neon: #00ff88;
            --tank-gold: #ffc107;
            --tank-dark: #0d1117;
        ...
        body.casino-mode {
            background: 
                radial-gradient(ellipse 80% 50% at 50% -20%, rgba(0, 255, 136, 0.12) 0%, transparent 50%),
                radial-gradient(ellipse 60% 40% at 100% 50%, rgba(255, 193, 7, 0.08) 0%, transparent 50%),
        ...
        /* Совместимость со старыми классами кнопок/карточек */
        .casino-gold, .casino-red, .casino-green, .casino-blue, .casino-purple, .casino-chip { }
        :root {
            --casino-gold: var(--tank-gold);
            --casino-red: var(--tank-red);
            --casino-green: var(--tank-neon);
            --casino-blue: #58a6ff;
            --casino-purple: #a371f7;
            --casino-chip: var(--tank-muted);
        }
        
        /* ===== 1TANK МЕНЮ ===== */
        .casino-menu {
            background: var(--tank-panel);
            padding: 14px 24px;
            margin: 20px auto;
            max-width: 1200px;
            border-radius: 12px;
        ...
        .casino-menu::before {
            ...
            right: 0;
            height: 3px;
            background: linear-gradient(90deg, var(--tank-neon), var(--tank-gold));
...
<body class="casino-mode">
    ...
    <div class="casino-menu">
        <nav class="casino-nav">
            ...
            <a href="casino.php" class="active">1TANK</a>
        </nav>
    </div>
    ...
    <div class="casino-container">
        <div class="casino-title">
            <h1>1TANK</h1>
            <div class="casino-subtitle">One tank. One shot.</div>
        ...
        <div class="games-grid">
            <div class="game-machine">
                ...
                <div class="machine-title">1TANK ROULETTE</div>
                <div class="machine-description">
                    Рулетка с одним зеро. Числа, красное/чёрное, зеро. До 35x.
                </div>
            ...
            <div class="game-machine">
                ...
                <div class="machine-title">1TANK SLOTS</div>
                <div class="machine-description">
                    5 барабанов, 20 линий. Бонусы, фриспины и джекпот в стиле 1TANK.
                </div>
                <div class="machine-stats">
                    <div class="stat-item">
            ...
            <div class="game-machine">
                ...
                <div class="machine-title">1TANK 21</div>
                <div class="machine-description">
                    21 очко против дилера. Классика с высоким RTP.
                </div>
                <div class="machine-stats">
                    <div class="stat-item">
        ...
        <div style="margin-top: 60px; text-align: center;">
            <h2 style="color: var(--tank-neon); font-family: 'Orbitron', sans-serif; margin-bottom: 30px;">
                ПОСЛЕДНИЕ ВЫИГРЫШИ
            </h2>
            ...
            <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
                <div style="background: rgba(255,215,0,0.1); padding: 15px 25px; border-radius: 10px; border: 1px solid var(--casino-gold);">
                    ...
                    <div style="color: var(--tank-gold); font-size: 0.9rem;">1TANK Slots</div>
                </div>
                ...
                <div style="background: rgba(220,20,60,0.1); padding: 15px 25px; border-radius: 10px; border: 1px solid var(--casino-red);">
                    ...
                    <div style="color: var(--tank-gold); font-size: 0.9rem;">1TANK Roulette</div>
                </div>
                ...
                <div style="background: rgba(50,205,50,0.1); padding: 15px 25px; border-radius: 10px; border: 1px solid var(--casino-green);">
                    ...
                    <div style="color: var(--tank-gold); font-size: 0.9rem;">1TANK 21</div>
                </div>
            </div>
    ...
    <div class="tank-footer" style="border-top: 1px solid var(--tank-border); color: var(--tank-muted);">
        1TANK © 2024 | <span style="color: var(--tank-neon);">Лицензия №1T-2024</span> | 
        <span id="onlineCount" style="color: var(--tank-neon);">247</span> онлайн
    </div>
