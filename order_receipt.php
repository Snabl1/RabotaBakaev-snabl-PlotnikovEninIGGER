...
$order = $pdo->query("
    SELECT o.*, c.last_name, c.first_name, c.middle_name, c.address as client_address, c.phone,
           dz.zone_name, dz.delivery_time_hours,
           w.warranty_type, w.warranty_period_months, w.description as warranty_desc
    FROM orders o 
    LEFT JOIN clients c ON o.client_id = c.client_id 
    LEFT JOIN delivery_zones dz ON o.zone_id = dz.zone_id
    LEFT JOIN warranties w ON o.warranty_id = w.warranty_id
...
<head>
    ...
    <nav class="menu-nav">
        ...
        <a href="#" onclick="window.print()" class="icon-ammo">🖨️ Печать</a>
    </nav>
</div>
