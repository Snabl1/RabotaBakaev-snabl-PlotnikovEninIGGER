    ...
    <div class="main-container">
        ...
        <aside class="left-sidebar">
            ...
            <div class="sidebar-section">
                <div class="sidebar-header">🔥 Популярное</div>
                <ul class="sidebar-list">
                    <?php for($i = 0; $i < 5; $i++): ?>
                    <li>
                        <span class="rank-number"><?= $i + 1 ?></span>
                        <div class="sidebar-item-img">👧</div>
                        <span class="sidebar-item-title">Товар #<?= $i + 1 ?></span>
                    </li>
                    <?php endfor; ?>
                </ul>
            </div>
            ...
            <!-- ТОП ГЕРОЕВ -->
            <div class="sidebar-section">
                <div class="sidebar-header">⭐ Топ клиентов</div>
                <ul class="sidebar-list">
                    <?php for($i = 0; $i < 3; $i++): ?>
                    <li>
                        <span class="rank-number"><?= $i + 1 ?></span>
                        <div class="sidebar-item-img">🎀</div>
                        <span class="sidebar-item-title">Брат #<?= $i + 1 ?></span>
                    </li>
                    <?php endfor; ?>
                </ul>
            </div>
            ...
            <!-- ОНГОИНГИ -->
            <div class="sidebar-section">
                <div class="sidebar-header">💕 Новинки</div>
                <ul class="sidebar-list">
                    <li>
                        <span class="rank-number">NEW</span>
                        <div class="sidebar-item-img">🌸</div>
                        <span class="sidebar-item-title">Свежий завоз!</span>
                    </li>
                    <li>
                        <span class="rank-number">HOT</span>
                        <div class="sidebar-item-img">🔥</div>
                        <span class="sidebar-item-title">Хит продаж</span>
                    </li>
                </ul>
            </div>
        </aside>
        ...
        <main class="main-content">
            ...
            <div class="hero-banner">
                ...
                <div class="hero-text">
                    <h2 class="hero-title">🌸 ANIME WORLD 🌸<br>ЛУЧШИЕ ТРУСИКИ!</h2>
            ...
            <div class="content-section">
                ...
                <div class="cards-grid">
                    <?php 
                    $recent_components = $pdo->query("SELECT * FROM components ORDER BY component_id DESC LIMIT 4")->fetchAll();
                    foreach($recent_components as $comp): 
                    ?>
            ...
            <div class="news-section">
                ...
                <div class="news-list">
                    <div class="news-item">
                        ...
                        <span class="news-text">Новый завоз товаров! Успей купить!</span>
                    </div>
                    <div class="news-item">
                        <span class="news-icon">💕</span>
                ...
                <div class="chat-messages">
                    ...
                    <div class="chat-message">
                        ...
                        <div class="chat-content">
                            ...
                            <div class="chat-text">Заказал трусики! Жду! 🎀</div>
                        </div>
                    </div>
                </div>
            </div>
